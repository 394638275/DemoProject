package com.lew.mapleleaf.utils.file;
...
final class BitmapUtil {
    ...
    public static BitmapFactory.Options calculateInSampleSize(final BitmapFactory.Options options, final int reqWidth, final int reqHeight) {
        final int height = options.outHeight;   // 源图片的高度和宽度
    ...
    public static Bitmap getBitmapFromView2(View view) {
        ...
        boolean willNotCache = view.willNotCacheDrawing();  // 能画缓存就返回false
     ...
     * @return 合成后的Bitmap
     */
    public static Bitmap combineImages(Bitmap bgBitmap, Bitmap frontBitmap) {
        int width = bgBitmap.getWidth() > frontBitmap.getWidth() ? bgBitmap.getWidth() : frontBitmap.getWidth();
        int height = bgBitmap.getHeight() > frontBitmap.getHeight() ? bgBitmap.getHeight() : frontBitmap.getHeight();
     ...
     * 合并
     *
     * @param bgBitmap 后景Bitmap
     * @param frontBitmap  前景Bitmap
     * @return 合成后Bitmap
     */
    public static Bitmap combineImagesToSameSize(Bitmap bgBitmap, Bitmap frontBitmap) {
        int width = bgBitmap.getWidth() < frontBitmap.getWidth() ? bgBitmap.getWidth() : frontBitmap.getWidth();
        int height = bgBitmap.getHeight() < frontBitmap.getHeight() ? bgBitmap.getHeight() : frontBitmap.getHeight();
        ...
        if (bgBitmap.getWidth() != width && bgBitmap.getHeight() != height) {
            bgBitmap = zoom(bgBitmap, width, height);
        }
        Bitmap bmp = Bitmap.createBitmap(width, height, Config.ARGB_8888);
        Paint paint = new Paint();
        paint.setXfermode(new PorterDuffXfermode(Mode.SRC_ATOP));
