...
public abstract class AutoScrollBase extends FrameLayout {
     ...
     */
    public abstract void setIndicatorVisible(boolean visible);
     ...
     * @param space 指示器之间间隔
     */
    public abstract void setIndicatorSpace(int space);
     ...
     */
    public abstract void setIndicatorVisibleInSingle(boolean visibleInSingle);
     ...
     */
    public abstract void setIndicatorBottomMargin(int bottomMargin);
     ...
     */
    public abstract void setOnIndicatorClickListener(OnIndicatorClickListener onIndictorClickListener);
    ...
    public interface OnIndicatorClickListener {
        void onIndicatorClick(View itemView, int position);
    }
