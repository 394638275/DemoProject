...
import com.lew.mapleleaf.ui.widgets.autoscrollpager.PageControlBase;
...
public class CustomPageControl extends PageControlBase<RelativeLayout> {
    ...
    private PageControlBase.Adapter mAdapter;
    ...
    @Override
    public void setIndicatorSpace(float indictorSpace) {
    ...
    public RelativeLayout containerView() {
        if (null == mContainerView) {
            ...
            mContainerView.setPadding(0, ScreenUtils.dip2px(mContext, 5f), 0, ScreenUtils.dip2px(mContext, 5f));
            ...
            lp1.leftMargin = ScreenUtils.dip2px(mContext, 10f);
            ...
            lp2.rightMargin = ScreenUtils.dip2px(mContext, 10f);
