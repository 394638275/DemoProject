...
/**
 * Created by liuqian 16/8/18.
 */
public class SwitchButtonActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void toast(String text) {
        Toast.makeText(SwitchButtonActivity.this, text, Toast.LENGTH_SHORT).show();
    }
}
